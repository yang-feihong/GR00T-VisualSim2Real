...
from groot.rl.isaac_utils.playground.utils.nucleus_utils import list_files_with_extension
from groot.rl.isaac_utils.playground.scripts.domelight_randomization import DomeLightRandomization

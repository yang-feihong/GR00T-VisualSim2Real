...
import omni.usd
from groot.rl.isaac_utils.playground.env_rand.table_grid import (
    TableGridSpawnerCfg,
    get_deterministic_table_grid_config,
    spawn_table_grid,
)
from groot.rl.isaac_utils.playground.utils.usd_utils import preload_materials

from groot.rl.simulator.isaacsim.isaacsim import DEFAULT_ISAACSIM_VERSION
...
def get_TaskObjCfgDict(num_envs, env_config, sim_device):
    TaskObjCfgDict = {
        ...
        "hold_object": RigidObjectCfg(
            ...
            #     activate_contact_sensors=True,
            #     usd_path="groot/rl/data/objects/simple/bottle.usd",
            #     scale=(1.0, 1.0, 1.0),
            #     rigid_props=sim_utils.RigidBodyPropertiesCfg(),
            #     visual_material=sim_utils.PreviewSurfaceCfg(),
            #     collision_props=sim_utils.CollisionPropertiesCfg(contact_offset=0.002, rest_offset=0.0, )
        ...
        "tray_object": RigidObjectCfg(
            ...
            spawn=sim_utils.UsdFileCfg(
                usd_path="groot/rl/data/objects/simple/tray-28-28-10-thick-15mm.usd",
                rigid_props=sim_utils.RigidBodyPropertiesCfg(
                    kinematic_enabled=True,
                ),
                collision_props=sim_utils.CollisionPropertiesCfg(

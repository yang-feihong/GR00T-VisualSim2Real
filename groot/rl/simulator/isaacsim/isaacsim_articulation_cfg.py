...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/ziwang/projects/gr00t-locomanip-internal/groot/rl/data/robots/g1/g1_29dof_with_hand_rev_1_0_homie.usd",
...
ARTICULATION_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path="groot/rl/data/robots/h1/h1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
# Haotian: moved task specific object configurations to "groot/rl/data/tasks"
# TaskObjCfgDict = {
...
#         spawn=sim_utils.UsdFileCfg(
#             usd_path="groot/rl/data/objects/simple/table.usd",
#             scale=(1.0, 1.0, 1.0),
#             rigid_props=sim_utils.RigidBodyPropertiesCfg(
#                 # disable_gravity=False,
#                 # retain_accelerations=False,

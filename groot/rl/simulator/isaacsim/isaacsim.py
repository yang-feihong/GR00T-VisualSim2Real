...
if DEFAULT_ISAACSIM_VERSION == "4.5":
    ...
    from groot.rl.simulator.isaacsim.isaaclab_viewpoint_camera_controller import (
    ...
    # from groot.rl.simulator.isaaclab_cfg import IsaacLabCfg
    ...
    from groot.rl.simulator.base_simulator.base_simulator import BaseSimulator
    from groot.rl.simulator.isaacsim.event_cfg import EventCfg
    from groot.rl.simulator.isaacsim.events import (
        cleanup_usd_memory,
    ...
    from groot.rl.simulator.isaacsim.isaacsim_articulation_cfg import ARTICULATION_CFG
    from groot.rl.utils.helpers import dict_to_true_list
    ...
    def _setup_scene(self):
        ...
        if "task_type" in self.__dict__ and self.task_type == "manipulation":
            import_cfg_path = os.path.join(
                "groot/rl/data/tasks/", f"{self.task_name}/scenario_cfg/isaacsim.py"
            )
        ...
        if self.config.simulator.config.get("randomize_dome_light", False):
            from groot.rl.isaac_utils.playground.env_rand.domelight import RandomDomeLightCfg

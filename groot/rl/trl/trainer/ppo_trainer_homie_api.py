...
from groot.rl.agents.modules.data_utils import RolloutStorage
from groot.rl.trl.callbacks.hv_callback_handler import HVCallbackHandler
from groot.rl.trl.utils.common import wandb_run_exists
from groot.rl.trl.utils.rl import compute_episode_attnmask
from groot.rl.trl.utils.scheduler import update_scheduled_params
from groot.rl.utils.average_meters import TensorAverageMeterDict
...
from groot.rl.trl.modules.homie_modules import (
    HIMActorCritic,
    HomieActorModule,
    ...
    def forward_component(self, mode, actions=None, **kwargs):
        if mode == "policy":
            ...
            if (
                ...
                from groot.rl.trl.utils.rl import unsplit_trajectories
...
class TRLPPOTrainer(PPOTrainer):
    ...
    def _get_rollout_data(self, obs_keys):
        ...
        if (hasattr(self.policy_model, "is_recurrent") and self.policy_model.is_recurrent) or (
            ...
            from groot.rl.trl.utils.rl import split_and_pad_trajectories

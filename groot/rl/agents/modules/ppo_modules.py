...
from groot.rl.utils.running_mean_std import RunningMeanStd
...
class VisionStateWithTransformModule(VisionStateModule):
    def __init__(
        ...
        from groot.data.schema import TrainableDatasetMetadata_V1_2
        ...
        if (
            ...
            == "groot.data.transform.StateActionTransform"
        ):
